...
import "./webworkerAll-BtyoFjA3.js";
import "./colorToUniform-lteTeJk6.js";
import "./getBatchSamplersUniformGroup-DdN_XinD.js";
class P {
  constructor(t) {
    (this.bubbles = !0),
      (this.cancelBubble = !0),
      ...
      (this.eventPhase = P.prototype.NONE),
...
class B {
  ...
  _activate() {
    ...
    this._isActive ||
      ...
      (t = this._renderer.view.canvas.parentNode) == null ||
  ...
  _deactivate() {
    ...
    !this._isActive ||
      ...
      (t = this._div.parentNode) == null || t.removeChild(this._div));
  }
  _updateAccessibleObjects(t) {
    if (!t.visible || !t.accessibleChildren) return;
    t.accessible &&
      t.isInteractive() &&
      (t._accessibleActive || this._addChild(t),
      (t._renderId = this._renderId));
    const e = t.children;
    if (e)
      for (let i = 0; i < e.length; i++) this._updateAccessibleObjects(e[i]);
  }
  init(t) {
    (this.debug = (t == null ? void 0 : t.debug) ?? this.debug),
      this._renderer.runners.postrender.remove(this);
  }
  postrender() {
    ...
    const {
      ...
      { width: o, height: r, resolution: d } = this._renderer,
      p = (s / o) * d,
      v = (n / r) * d;
    let a = this._div;
    (a.style.left = `${e}px`),
    ...
    for (let h = 0; h < this._children.length; h++) {
      ...
      if (l._renderId !== this._renderId)
        (l._accessibleActive = !1),
          U(this._children, h, 1),
          this._div.removeChild(l._accessibleDiv),
        ...
        l.hitArea
          ? ((a.style.left = `${(E.tx + c.x * E.a) * p}px`),
            (a.style.top = `${(E.ty + c.y * E.d) * v}px`),
            (a.style.width = `${c.width * E.a * p}px`),
            (a.style.height = `${c.height * E.d * v}px`))
          : ((c = l.getBounds().rectangle),
            this._capHitArea(c),
            (a.style.left = `${c.x * p}px`),
            (a.style.top = `${c.y * v}px`),
            (a.style.width = `${c.width * p}px`),
            (a.style.height = `${c.height * v}px`),
            a.title !== l.accessibleTitle &&
              l.accessibleTitle !== null &&
              (a.title = l.accessibleTitle || ""),
            a.getAttribute("aria-label") !== l.accessibleHint &&
              l.accessibleHint !== null &&
              a.setAttribute("aria-label", l.accessibleHint || "")),
          (l.accessibleTitle !== a.title || l.tabIndex !== a.tabIndex) &&
            ((a.title = l.accessibleTitle || ""),
            (a.tabIndex = l.tabIndex),
  ...
  _dispatchEvent(t, e) {
    const { container: i } = t.target,
      s = this._renderer.events.rootBoundary,
      n = Object.assign(new P(s), { target: i });
    (s.rootTarget = this._renderer.lastObjectRendered),
      e.forEach((o) => s.dispatchEvent(n, o));
  }
  _onClick(t) {
...
B.extension = { type: [T.WebGLSystem, T.WebGPUSystem], name: "accessibility" };
const j = {
  accessible: !1,
...
class N {
  ...
  addTickerListener() {
    this._tickerAdded ||
      !this.domElement ||
      (D.system.add(this._tickerUpdate, this, H.INTERACTION),
      (this._tickerAdded = !0));
  }
  removeTickerListener() {
    this._tickerAdded &&
      (D.system.remove(this._tickerUpdate, this), (this._tickerAdded = !1));
  }
  pointerMoved() {
    this._didMove = !0;
  }
...
class M extends P {
  ...
  initMouseEvent(t, e, i, s, n, o, r, d, p, v, a, h, l, c, E) {
...
class Z {
  ...
  mapEvent(t) {
    ...
    else m(`[EventBoundary]: Event mapping not defined for ${t.type}`);
  }
  hitTest(t, e) {
    y.pauseUpdate = !0;
    const s =
  ...
  hitTestMoveRecursive(t, e, i, s, n, o = !1) {
    ...
    if (
      ((t.eventMode === "dynamic" || e === "dynamic") && (y.pauseUpdate = !1),
      t.interactiveChildren && t.children)
    ) {
      const v = t.children;
      for (let a = v.length - 1; a >= 0; a--) {
        const h = v[a],
          l = this.hitTestMoveRecursive(
            h,
        ...
        if (l) {
          ...
          (l.length > 0 || c) &&
            (c && this._allInteractiveElements.push(t), l.push(t)),
            this._hitElements.length === 0 && (this._hitElements = l),
            (r = !0);
        }
      }
    }
    const d = this._isInteractive(e),
      p = t.isInteractive();
    return (
      p && p && this._allInteractiveElements.push(t),
  ...
  hitPruneFn(t, e) {
    if (
      t.hitArea &&
      (t.worldTransform.applyInverse(e, b), !t.hitArea.contains(b.x, b.y))
    )
      return !0;
  ...
  hitTestFn(t, e) {
    return t.hitArea
      ? !0
      : t != null && t.containsPoint
      ? (t.worldTransform.applyInverse(e, b), t.containsPoint(b))
      : !1;
  }
  notifyTarget(t, e) {
    var n, o;
  ...
  mapPointerMove(t) {
    ...
    if (
      ((d = s.overTargets) == null ? void 0 : d.length) > 0 &&
      n !== e.target
    ) {
      const v = t.type === "mousemove" ? "mouseout" : "pointerout",
        a = this.createPointerEvent(t, v, n);
      if (
        (this.dispatchEvent(a, "pointerout"),
        i && this.dispatchEvent(a, "mouseout"),
        !e.composedPath().includes(n))
      ) {
        const h = this.createPointerEvent(t, "pointerleave", n);
        for (
          h.eventPhase = h.AT_TARGET;
          h.target && !e.composedPath().includes(h.target);

        )
          (h.currentTarget = h.target),
            this.notifyTarget(h),
            i && this.notifyTarget(h, "mouseleave"),
    ...
    if (n !== e.target) {
      const v = t.type === "mousemove" ? "mouseover" : "pointerover",
        a = this.clonePointerEvent(e, v);
      this.dispatchEvent(a, "pointerover"),
        i && this.dispatchEvent(a, "mouseover");
    ...
    const o = [],
      r = this.enableGlobalMoveEvents ?? !0;
    this.moveOnAll
      ? o.push("pointermove")
      : this.dispatchEvent(e, "pointermove"),
      r && o.push("globalpointermove"),
      e.pointerType === "touch" &&
        (this.moveOnAll
          ? o.splice(1, 0, "touchmove")
          : this.dispatchEvent(e, "touchmove"),
        r && o.push("globaltouchmove")),
      i &&
        (this.moveOnAll
          ? o.splice(1, 0, "mousemove")
          : this.dispatchEvent(e, "mousemove"),
        r && o.push("globalmousemove"),
        (this.cursor = (p = e.target) == null ? void 0 : p.cursor)),
  ...
  mapPointerUp(t) {
    ...
    if (o) {
      ...
      if (
        (d.target === r.target && e - d.timeStamp < 200
          ? ++d.clickCount
          : (d.clickCount = 1),
        (d.target = r.target),
        (d.timeStamp = e),
        (r.detail = d.clickCount),
        r.pointerType === "mouse")
      ) {
        const p = r.button === 2;
  ...
  A = class I {
    constructor(t) {
      (this.supportsTouchEvents = "ontouchstart" in globalThis),
        ...
        (this.resolution = 1),
        (this.renderer = t),
        (this.rootBoundary = new Z(null)),
        y.init(this),
        (this.autoPreventDefault = !0),
        (this._eventsAdded = !1),
        (this._rootPointerEvent = new g(null)),
        (this._rootWheelEvent = new _(null)),
    ...
    init(t) {
      ...
      this.setTargetElement(e),
        (this.resolution = i),
        (I._defaultEventMode = t.eventMode ?? "passive"),
    ...
    _onPointerUp(t) {
      ...
      const i = e !== this.domElement ? "outside" : "",
        s = this._normalizeToPointerData(t);
    ...
    _normalizeToPointerData(t) {
      ...
      if (this.supportsTouchEvents && t instanceof TouchEvent)
        ...
        typeof i.isPrimary > "u" && (i.isPrimary = !0),
          ...
          typeof i.pointerId > "u" && (i.pointerId = V),
    ...
    _bootstrapEvent(t, e) {
      return (
        ...
        t.type.startsWith("touch") && (t.type = q[t.type] || t.type),
        t
      );
    }
...
A.extension = {
  name: "events",
  type: [T.WebGLSystem, T.CanvasSystem, T.WebGPUSystem],
  priority: -1,
};
A.defaultEventFeatures = { move: !0, globalMove: !0, click: !0, wheel: !0 };
let C = A;
const J = {
  onclick: null,
  onmousedown: null,
  ...
  addEventListener(u, t, e) {
    ...
    u = i ? `${u}capture` : u;
    const r = typeof t == "function" ? t : t.handleEvent,
      d = this;
    s &&
      s.addEventListener("abort", () => {
        d.off(u, r, o);
      }),
      n ? d.once(u, r, o) : d.on(u, r, o);
  },
